...
echo sprintf('   • Post info ID     : %d', $address->locality()->postInfoId()->value()), PHP_EOL;
echo sprintf('   • Postal code      : %d', $address->locality()->postalCode()), PHP_EOL;
echo sprintf('   • Locality name ID : %s', $address->locality()->localityName()->name()), PHP_EOL;
echo sprintf('   • Locality name    : %d', $address->locality()->localityName()->localityNameId()->value()), PHP_EOL;
